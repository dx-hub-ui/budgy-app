...
2. **Cabeçalho do orçamento** – ocupa toda a largura útil dentro do conteúdo principal (sem topbar global) e agora usa um cartão branco (#FFFFFF) com tipografia em cinza-escuro (#1E1E1E). As setas de navegação continuam em ícones cinza (#6E6E6E) com hover azul (#5865F2), enquanto o card central "Pronto para atribuir" foi redesenhado para um bloco compacto (largura útil ≈220 px) totalmente centralizado. Ele traz apenas o rótulo em caixa alta (tracking de 0,32 em), o valor formatado e o botão arredondado "Atribuir"; o fundo passou para o gradiente sólido lima claro #CBFF86 com borda #AEE96F e sombra profunda (`0 14px 34px rgba(33,102,16,0.22)`), e o botão usa verde escuro #1C3A0D com texto branco e ícone `ChevronDown`, mantendo os estados de foco/desabilitado acessíveis. O bloco também conserva o acesso rápido aos grupos de categorias e os botões `Desfazer`/`Refazer` (atalhos `⌘/Ctrl+Z` e `Shift+⌘/Ctrl+Z`).
